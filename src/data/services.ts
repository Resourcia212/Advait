...
export const SERVICE_CATEGORIES: CategoryInfo[] = [
  ...
  {
    id: 'restorative',
    name: 'Restorative & General Dentistry',
    nameMarathi: 'रिस्टोरेटिव्ह व सामान्य दंतोपचार',
    icon: 'Hammer',
    description: {
      en: 'Root Canal Treatment (RCT), crowns, bridges, ultrasonic cleanings, fillings, and extractions.',
      mr: 'रूट कॅनॉल (RCT), दर्जेदार क्राउन्स, पक्के ब्रीज, दात साफ करणे व सामान्य उपचार.'
    }
  }
];
...
export const ALL_SERVICES: ServiceItem[] = [
  // ==========================================
  // 1. Dental Implants & Prosthodontics (Primary Focus)
  // ==========================================
  {
  ...
  // ==========================================
  // 4. Restorative & General Dentistry
  // ==========================================
  {
  ...
  },
  {
    ...
    fullDescription: {
      ...
      mr: "कमीत कमी दात घासून दाताला Chemical बाँडिंगने जोडले जाणारे अत्याधुनिक सिमेंट."
    },
    indications: {
